...
const columns = [
  { key: 'external_po_ref', header: 'external_po_ref', width: 22, group: 'required', note: 'Old PO number. Required on the first line of the PO; later lines may be blank (same PO).' },
  ...
  { key: 'brand_name', header: 'brand_name', width: 20, group: 'required', note: 'Hub warehouse brand. Fill on the first line of that brand; later variants may leave it blank. Write again when the brand changes.' },
  ...
  { key: 'warehouse_location_name', header: 'warehouse_location_name', width: 26, group: 'optional', note: 'Ignored. Import always uses the linked hub main warehouse.' },
  { key: 'discount', header: 'discount', width: 12, group: 'optional', note: 'PO header discount. Default 0. Fill on the first line; later lines may be blank.' },
  { key: 'rfpf_number', header: 'rfpf_number', width: 18, group: 'recommended', note: 'PO header RFPF. Fill on the first line of the PO; later lines may be blank. Leave empty if none.' },
...
const examples = [
  {
    ...
    notes: 'DELETE this sample — first line of the PO',
    sku: '',
    client_code: '',
    shop_code: '',
    payment_amount: '',
  ...
  },
  {
    ...
    discount: '',
    rfpf_number: '',
    notes: 'Same PO and Brand A — ref / brand / RFPF blank',
    sku: '',
    client_code: '',
    shop_code: '',
    payment_amount: '',
  ...
  },
  {
    ...
    discount: '',
    rfpf_number: '',
    notes: 'Same PO, new brand — write brand_name only',
    sku: '',
    client_code: '',
    shop_code: '',
    payment_amount: '',
...
async function main() {
  ...
  const readmeRows = [
    ...
    ['2', 'Fill sheet PO_Lines. Delete the sample rows before a real import.'],
    ['3', 'First line of a PO: fill external_po_ref, order_date, client, shop, address, RFPF. Extra lines may leave those blank. Write brand_name again only when the brand changes.'],
  ...
  const guideBody = [
    ['external_po_ref', 'Required', 'You', 'Required on the first line of the PO. Later lines may be blank (same PO). Not the system PO number.'],
    ...
    ['brand_name', 'Required', 'You', 'Hub brand. Fill on the first line of that brand; later variants may leave it blank. Write again when the brand changes.'],
    ...
    ['warehouse_location_name', 'Optional', 'You', 'Ignored. Always uses the linked hub main warehouse.'],
    ['discount', 'Optional', 'You', 'Header discount for the whole PO. Default 0.'],
    ['rfpf_number', 'Recommended', 'You', 'PO header RFPF. Fill on the first line of the PO; later lines may be blank. Blank if the old PO had none.'],
