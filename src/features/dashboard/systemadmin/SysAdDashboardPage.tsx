...
export default function SysAdDashboardPage() {
  ...
  const fetchCompanies = async () => {
    try {
      ...
      // For now, show empty state until database is set up
      setCompanies([]);
      if (error.message && !error.message.includes('SQL database removed')) {
        toast({
          variant: 'destructive',
  ...
  const handleCreateCompany = async () => {
    ...
    if (
      ...
      !newCompany.super_admin_name ||
      !newCompany.super_admin_email ||
      !newCompany.super_admin_password
    ) {
      toast({
        variant: 'destructive',
    ...
    // Password validation
    if (newCompany.super_admin_password.length < 6) {
      toast({
        variant: 'destructive',
        title: 'Weak password',
    ...
    try {
      ...
      toast({
        ...
        description: error.message || 'Failed to create company and super admin',
      });
    } finally {
      setIsCreating(false);
    }
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setNewCompany({ ...newCompany, company_email: e.target.value })
                  }
                ...
                <div className="space-y-5">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewCompany({ ...newCompany, super_admin_name: e.target.value })
                      }
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        setNewCompany({ ...newCompany, super_admin_email: e.target.value })
                      }
                  ...
                  <div className="space-y-2">
                    <p className="text-xs text-muted-foreground">
                      Default password: <span className="font-mono">tempPassword123!</span>
                    </p>
                  </div>
                </div>
              </div>
