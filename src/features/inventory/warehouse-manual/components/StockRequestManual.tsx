  ...
  return (
    ...
    <div className="flex flex-col items-center">
      ...
      <InstructionBorder>
        ...
        <span>2. Enter <span className="text-blue-500">Boxes</span> and <span className="text-blue-500">Qty/box</span> for each variant. Optionally add leftover stock with <span className="text-blue-500">Loose Boxes</span> and <span className="text-blue-500">Loose Qty</span> (leave both blank, or fill both). <span className="text-blue-500">Total</span> is calculated as (Boxes × Qty/box) + (Loose Boxes × Loose Qty)</span>
        ...
        <span>6. The received stock will be added to Main Inventory under one batch number. Boxes, Qty/box, and optional Loose Boxes/Loose Qty are saved and shown in the request view. You can export a Stock Receive Receipt PDF from receive history.</span>
