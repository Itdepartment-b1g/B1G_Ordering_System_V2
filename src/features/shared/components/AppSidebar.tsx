...
const adminMenuItems: MenuItem[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { title: 'TL Stock Transfers', url: '/inventory/admin-tl-requests', icon: Users },
      { title: 'TL Transfer Shortages', url: '/inventory/tl-transfer-shortages', icon: PackageSearch },
...
const salesAdminMenuItems: MenuItem[] = [
...

  {
    ...
    submenu: [
      ...
      { title: 'Sales Tracker Import', url: '/key-accounts/sales-tracker-import', icon: FileSpreadsheet },
...
const leaderMenuItems: MenuItem[] = [
  ...
  { title: 'Analytics', url: '/analytics', icon: Brain },
  {
    ...
    submenu: [
      ...
      { title: 'Stock Transfers', url: '/inventory/tl-stock-requests', icon: ArrowRightLeft },
