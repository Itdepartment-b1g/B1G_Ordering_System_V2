-- ============================================================================
-- FIX STOCK APPROVAL FOR DIRECT LEADER REQUESTS
-- ============================================================================
-- Updates admin_approve_stock_request to handle direct leader requests differently:
-- 1. If agent_id = leader_id (Direct Leader Request):
--    - Skip allocation phase.
--    - Immediately deduct from main_inventory.stock.
--    - Immediately add to leader's agent_inventory.
--    - Mark request as 'fulfilled'.
-- 2. If agent_id != leader_id (Mobile Agent Request):
--    - Keep existing logic (allocate stock, wait for leader distribution).
-- ============================================================================
