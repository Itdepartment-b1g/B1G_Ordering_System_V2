-- Fix: fulfill_po_location inserted unit_price/selling_price into public.variants (columns do not exist).
-- Pricing belongs on main_inventory; variant catalog rows match approve_warehouse_transfer_po.
