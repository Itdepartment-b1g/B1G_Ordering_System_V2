-- Only the assigned team leader may call receive_po_delivery for warehouse-transfer POs.
...
COMMENT ON FUNCTION public.receive_po_delivery(uuid, jsonb, text, text, text, text, uuid) IS
  'Assigned team leader receives a warehouse-transfer dispatch: credits Standard Account inventory; shortfalls open warehouse discrepancy tickets.';
